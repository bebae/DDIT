...
public class CarTest {
	...
	public static void main(String[] args) {
		...
		NewCar youCar = new NewCar("blue");
		System.out.println();
		System.out.println("myCar의 색: "+youCar.getColor());
		System.out.println("차의 최대 속력: "+Car.getMaxSpeed()+"km/h");
		
		System.out.print("첫 번째 speedUp(-100.0km/h): ");
		if (youCar.speedUp(-100.0)) {
			System.out.print("속도 변경 가능");
		} else {
			System.out.print("속도 변경 불가능,");
		}
		System.out.println(" 현재 차의 속력: "+youCar.getSpeed()+"km/h");
	
		System.out.print("두 번째 speedUp(210.0km/h): ");
		if (youCar.speedUp(210.0)) {
			System.out.print("속도 변경 가능");
		} else {
			System.out.print("속도 변경 불가능,");
		}
