...
//VO : Value Object / DTO : Data Transport Object (데이터를 담아서 묶어서 보냄)
...
public class UsersVO {
	...
	//동일 클래스에서 같은 이름의 메소드를 사용 : 오버로딩(파라미터의 개수, 파라미터의 타입)
	//기본생성자(생략가능->(다른 생성자 있을 때에는 생략불가))
	public UsersVO() {}
	//기본생성자(constructor)
	...
	//setter메소드 (리턴타입 : void (세팅하고 끝))
	//010,1111,2222 파라미터를 받아서 010-1111-2222를 phone 멤버변수에 setting해주는 메소드
	public void setPhones(String phone1, String phone2, String phone3) {
		this.phone = phone1 + "-" + phone2 + "-" + phone3; //this : VO클래스 자체 
	}
	@Override
